...
describe "Store" do
  {
    ...
    describe label.to_s do
      ...
      it "should create BNodes" do
        bn_id = subject.generate_bn_identifier
        bn_id.should_not be_nil
        subject.generate_bn_identifier.should_not == bn_id
      end
      
      it "should remember named BNodes" do
        subject.named_nodes.should be_a(Hash)
      end
